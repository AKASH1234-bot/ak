...
# ✅ FIX 1: Removed blocking 'requests' import — using aiohttp everywhere
import aiohttp
...
async def get_poster(query, bulk=False, id=False, file=None):
    if not id:
        ...
        # ✅ FIX 2: Wrapped blocking Cinemagoer calls in asyncio.to_thread()
        # so they don't freeze the bot for other users
    ...
    # ✅ FIX 2 continued: get_movie also wrapped
...
# ✅ FIX 3: Changed recursive FloodWait to a loop to prevent stack overflow
async def broadcast_messages(user_id, message):
    while True:
        try:
            ...
            # loop retries instead of recursing
...
# ✅ FIX 1 continued: search_gagala now fully async using aiohttp (no blocking requests)
